...
var ProviderRegistry = /** @class */ (function () {
    ...
    ProviderRegistry.prototype.get = function (name) {
        var provider = this.providers.get(name);
        if (!provider) {
            throw new Error("Provider ".concat(name, " not found in registry."));
        }
        return provider;
    };
    ProviderRegistry.prototype.initializeAll = function () {
        return __awaiter(this, void 0, void 0, function () {
            var _i, _a, provider;
            return __generator(this, function (_b) {
                switch (_b.label) {
                    case 0:
                        _i = 0, _a = Array.from(this.providers.values());
                        _b.label = 1;
                    case 1:
